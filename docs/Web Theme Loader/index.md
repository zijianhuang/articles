...
If you just want to use this loader right away, please check "[Web Theme Loader with Comprehensive Features and Minimum API Surface](../Web%20Theme%20Loader%20Tips/)"
...
2. Support more than two themes.  
...
themeLoader.ts ([full sourcecode](https://github.com/zijianhuang/nmce/blob/master/projects/theme-loader-api/src/lib/themeLoader.ts))
 ```ts
...
Data schema ([full sourcecode](https://github.com/zijianhuang/nmce/blob/master/projects/theme-loader-api/src/lib/themeDef.ts)):
```ts
...
siteconfig.js ([full sourcecode](https://github.com/zijianhuang/DemoCoreWeb/blob/master/ReactHeroes/public/conf/siteconfig.js)):
```js
const THEME_CONFIG = {
	themesDic: {
...
* Depending on your app design, you may hardcode the details of `THEME_CONFIG` in code without using a JS file.
...
And you may do the same for [React apps](https://github.com/zijianhuang/DemoCoreWeb/blob/master/ReactHeroes/src/main.tsx) and alike.
...
7. Migrating legacy React app to newer React lib.
8. ...
